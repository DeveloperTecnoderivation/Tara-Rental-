  ...
  <div class="span9" id="content">
      ...
      <div class="navbar">
        <div class="navbar-inner">
          <ul class="breadcrumb">
            ...
            <i class="fa fa-angle-right show-sidebar" style="display:none;"><a href="#" title="Show Sidebar" rel="tooltip">&nbsp;</a></i><li><a href="<?php echo $base_url ?>/dashboard.php">Dashboard</a> <span class="divider">/</span></li><li><a href="#">Brand</a> <span class="divider">/</span></li><li class="active">Edit Brand</li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="block">
      <div class="navbar navbar-inner block-header">
        <div class="muted pull-left">Edit Brand</div>
      </div>
      <div class="block-content collapse in">
        <div class="span12">
           <?php
            ...
            <?php
                $pid=$_REQUEST['pid'];
                $getdata="select * from tbl_vehicle_brand where id=$pid";  
    ...
    function submitDetailsForm() {
      ...
      if((name == '') || (name == undefined)){
        ...
        if(error == 1){
            ...
            $.ajax({
                url: '<?php echo $base_url ?>/brand/check_edit_exist.php',
                type: 'post',
                data: {
                  name: name,
                  table_name: 'tbl_vehicle_brand',
                  pid: '<?php echo $pid; ?>',
                ...
                if (response == 'success') {
                    ...
                    toastr.error('Make Name Already Exist!');
                 }else{
                    toastr.optionsOverride = 'positionclass = "toast-bottom-left"';
                    toastr.options.positionClass = 'toast-bottom-left';
