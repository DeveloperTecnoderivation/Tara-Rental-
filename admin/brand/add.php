  ...
  <div class="span9" id="content">
      ...
      <div class="navbar">
        <div class="navbar-inner">
          <ul class="breadcrumb">
            ...
            <i class="fa fa-angle-right show-sidebar" style="display:none;"><a href="#" title="Show Sidebar" rel="tooltip">&nbsp;</a></i><li><a href="<?php echo $base_url ?>/dashboard.php">Dashboard</a> <span class="divider">/</span></li><li><a href="#">Brand</a> <span class="divider">/</span></li><li class="active">Add Brand</li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="block">
      <div class="navbar navbar-inner block-header">
        <div class="muted pull-left">Add New Brand</div>
      </div>
           ...
           <?php
            ...
            <fieldset>              
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="name" class="input-xlarge focused" placeholder="Brand Name" id="name" required="required">
...
<script language="javascript" type="text/javascript">
    function submitDetailsForm() {
      ...
      if(error == 1){
            ...
            $.ajax({
                url: '<?php echo $base_url ?>/brand/check_exist.php',
                type: 'post',
                data: {
                  name: name,
