  ...
  <div class="span9" id="content">
      ...
      <div class="navbar">
        <div class="navbar-inner">
          <ul class="breadcrumb">
            ...
            <i class="fa fa-angle-right show-sidebar" style="display:none;"><a href="#" title="Show Sidebar" rel="tooltip">&nbsp;</a></i><li><a href="<?php echo $base_url ?>/dashboard.php">Dashboard</a> <span class="divider">/</span></li><li><a href="#">Car Owner</a> <span class="divider">/</span></li><li class="active">Edit Car Owner</li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="block">
      <div class="navbar navbar-inner block-header">
        <div class="muted pull-left">Edit Car Owner</div>
      </div>
      <div class="block-content collapse in">
        <div class="span12">
           <?php
            ...
            <?php
                $pid=$_REQUEST['pid'];
                $getdata="select * from tbl_car_owner where id=$pid";  
    ...
    function submitDetailsForm() {
      ...
      if((phone == '') || (phone == undefined)){
        ...
        if(error == 1){
            ...
            $.ajax({
                url: '<?php echo $base_url ?>/car_owner/check_edit_exist.php',
                type: 'post',
                data: {
                  email: email,
                  phone: phone,
