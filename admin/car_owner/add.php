  ...
  <div class="span9" id="content">
      ...
      <div class="navbar">
        <div class="navbar-inner">
          <ul class="breadcrumb">
            ...
            <i class="fa fa-angle-right show-sidebar" style="display:none;"><a href="#" title="Show Sidebar" rel="tooltip">&nbsp;</a></i><li><a href="<?php echo $base_url ?>/dashboard.php">Dashboard</a> <span class="divider">/</span></li><li><a href="#">Car Owner</a> <span class="divider">/</span></li><li class="active">Add Car Owner</li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="block">
      <div class="navbar navbar-inner block-header">
        <div class="muted pull-left">Add New Car Owner</div>
      </div>
           ...
           <?php
            ...
            <fieldset>              
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="f_name" class="input-xlarge focused" placeholder="First Name" id="f_name" required="required">
    ...
    function submitDetailsForm() {
      ...
      if((password == '') || (password == undefined)){
        ...
        if(error == 1){
            ...
            $.ajax({
                url: '<?php echo $base_url ?>/car_owner/check_exist.php',
                type: 'post',
                data: {
                  email: email,
                  phone: phone,
