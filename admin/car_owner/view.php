          ...
          <div class="navbar">
            <div class="navbar-inner">
              <ul class="breadcrumb">
                ...
                <i class="fa fa-angle-right show-sidebar" style="display:none;"><a href="#" title="Show Sidebar" rel="tooltip">&nbsp;</a></i><li><a href="<?php echo $base_url ?>/dashboard.php">Dashboard</a> <span class="divider">/</span></li><li class="active">Car Owner List</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="row-fluid">
          ...
          <div class="block">
            <div class="navbar navbar-inner block-header">
              <div class="muted pull-left">Car Owner Management </div>
            </div>
            <div class="block-content collapse in">
              <div class="span12">
                <div class="table-toolbar">
                  <div class="btn-group">
                    <a href="<?php echo $base_url ?>/car_owner/add.php"><button class="btn btn-success">Add New <i class="fa fa-plus icon-white"></i></button></a>
                  </div>
                </div>
                <br>
                ...
                // echo $_GET['name'];
                    ...
                    $sql = "select * from  tbl_users  WHERE 1 = 1 {$whereSQL1} {$whereSQL2} and role='car_owner' order by id asc";
                  ...
                  <tbody>
                    ...
                    { ?>
                      ...
                      foreach($arr_users as $user) { 
                          ...
                          $getdata_car_owner="select * from tbl_car where car_owner_id=$car_owner_id";  
                          $gdata_car_owner=mysqli_query($connect,$getdata_car_owner);
                          $rown_car_owner=mysqli_num_rows($gdata_car_owner);


                          $getdata_car_booking="select * from tbl_car_order_booking where car_owner_id=$car_owner_id";  
                      ...
                      <tr>
                          ...
                          <td><?php echo $rown_car_owner; ?></td>
                          <td><a href="view_cars.php?car_owner_id=<?php print $user['id']?>"><i class="fa fa-eye"></i></a></td>
                          <td><?php echo $rown_car_booking ?></td>
                          <td><a href="view_booking_cars.php?car_owner_id=<?php print $user['id']?>"><i class="fa fa-eye"></i></a></td>
