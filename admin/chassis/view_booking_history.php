            ...
            <div class="block-content collapse in">
                <div class="span12">
                    <div class="table-toolbar">
                        <div class="btn-group">
                            <a href="<?php echo $base_url ?>/chassis/view.php"><button class="btn btn-warning"><i class="fa fa-arrow-left icon-white"></i> Back</button></a>
                        </div>
                    </div>
                    <br>
                    ...
                    if (!empty($_GET['chassis_id']) && is_numeric($_GET['chassis_id'])) {
                        $chassis_id = intval($_GET['chassis_id']);
                        $where .= " AND chassis_id = $chassis_id";
                    } else {
