...
echo $updt="update tbl_truck set truck_partner_id='$truck_partner_id',model='$model',plate_no='$plate_no',trailer_type='$trailer_type',image='$image',or_cr='$or_cr' where id = $pid "; 
