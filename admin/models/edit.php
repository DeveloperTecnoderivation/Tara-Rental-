  ...
  <div class="span9" id="content">
      ...
      <div class="navbar">
        <div class="navbar-inner">
          <ul class="breadcrumb">
            ...
            <i class="fa fa-angle-right show-sidebar" style="display:none;"><a href="#" title="Show Sidebar" rel="tooltip">&nbsp;</a></i><li><a href="<?php echo $base_url ?>/dashboard.php">Dashboard</a> <span class="divider">/</span></li><li><a href="#">Model</a> <span class="divider">/</span></li><li class="active">Edit Model</li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="block">
      <div class="navbar navbar-inner block-header">
        <div class="muted pull-left">Edit Model</div>
      </div>
      <div class="block-content collapse in">
        <div class="span12">
           <?php
            ...
            <?php
                $pid=$_REQUEST['pid'];
                $getdata="select * from tbl_vehicle_models where id=$pid";  
               ...
               <div class="control-group">
                    ...
                    <div class="controls">
                        <select  name="make_id" class="form-control" id="make_id" required="required" >
                          ...
                          ?>
                          <option value="<?php echo $make_list["id"];?>" <?php if($rown['make_id'] == $make_list["id"]){ echo "selected"; }?>><?php echo $make_list["name"];?></option> 
                          <?php } ?>
                        </select>
                    </div>
                </div>
      ...
      if((name == '') || (name == undefined)){
       ...
       if((make_id == '') || (make_id == undefined)){
        ...
        if(error == 1){
            ...
            $.ajax({
                url: '<?php echo $base_url ?>/models/check_edit_exist.php',
                type: 'post',
                data: {
                  name: name,
                  make_id: make_id,
