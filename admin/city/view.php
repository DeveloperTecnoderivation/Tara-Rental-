          ...
          <div class="navbar">
            <div class="navbar-inner">
              <ul class="breadcrumb">
                ...
                <i class="fa fa-angle-right show-sidebar" style="display:none;"><a href="#" title="Show Sidebar" rel="tooltip">&nbsp;</a></i><li><a href="<?php echo $base_url ?>/dashboard.php">Dashboard</a> <span class="divider">/</span></li><li class="active">City List</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="row-fluid">
          ...
          <div class="block">
            <div class="navbar navbar-inner block-header">
              <div class="muted pull-left">City Management </div>
            </div>
            <div class="block-content collapse in">
              <div class="span12">
                <div class="table-toolbar">
                  <div class="btn-group">
                    <a href="<?php echo $base_url ?>/city/add.php"><button class="btn btn-success">Add New <i class="fa fa-plus icon-white"></i></button></a>
                  </div>
                </div>
                <br>
                <form action="" method="get" class="form-horizontal" accept-charset="utf-8">
                  <div class="row-fluid">
                    ...
                    <div class="span4" id="state_details">
                        
                    </div>

                    <div class="span4">
                      <input type="text" name="name" class="input-xlarge focused" placeholder="City Name" id="name" value="<?php echo $_GET['name'] ?>">
                    </div>
                ...
                // echo $_GET['name'];
                   ...
                   $sql = "select * from  tbl_city  WHERE 1 = 1 {$whereSQL1} {$whereSQL2} order by id asc";
                    ...
                    { ?>
                      ...
                      foreach($arr_users as $user) { 
                        ...
                        $country_name = $rown_country['country_name']; 
                         ...
                         $getdata_state="select * from tbl_state where id=$state_id";  
                        $gdata_state=mysqli_query($connect,$getdata_state);
                        $rown_state=mysqli_fetch_array($gdata_state);
                        $state_name = $rown_state['name']; 
...
function fetchStates(cid){
  if(cid>0)
    {
     $.ajax({
         url:"<?php echo $base_url ?>/ajax/fetch_state_view.php",
        method:"POST",
        data:{country_id:cid},
