    ...
    <div class="row-fluid">
        ...
        <div class="block">
            ...
            ?>
                    ...
                    <form id="add_form" name="add_form" class="form-horizontal" method="post" action="save.php"
                        ...
                        <fieldset>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="password" name="password" class="input-xlarge focused"
                                        placeholder="Password" id="password" required="required">
                                    <div id="password_error" class="error_msg"></div>
                                </div>
                            </div>
                            <div class="form-actions">
                                <input type="button" name="add_makes" value="Add" class="btn btn-primary"
                                    onclick="submitDetailsForm()">
                                <a class="btn" href="view.php">Cancel</a>
                            </div>
                        </fieldset>
                    </form>
                </div>
