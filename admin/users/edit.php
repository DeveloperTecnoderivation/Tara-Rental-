    ...
    <div class="row-fluid">
        ...
        <div class="block">
            ...
            ?>
                    ...
                    <form id="edit_form" name="edit_form" class="form-horizontal" method="post" action="update.php"
                        enctype="multipart/form-data">
                        <fieldset>
                            <div class="control-group">
                                <label class="control-label" for="focusedInput">First Name</label>
                                <div class="controls">
                                    <input type="text" name="f_name" class="input-xlarge focused"
                                        placeholder="First Name" id="f_name" required="required"
                                        value="<?php echo $rown['f_name']?>">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="l_name" class="input-xlarge focused"
                                        placeholder="Last Name" id="l_name" required="required"
                                        value="<?php echo $rown['l_name']?>">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="email" name="email" class="input-xlarge focused" placeholder="Email"
                                        id="email" required="required" value="<?php echo $rown['email']?>">
                    ...
                    <?php } ?>
                                    ...
                                    <input type="tel" name="phone" class="input-xlarge focused"
                                        placeholder="Phone Number" id="phone" required="required"
                                        value="<?php echo $rown['phone']?>">
                            ...
                            <div class="form-actions">
                                ...
                                <input type="button" name="add_makes" value="Update" class="btn btn-primary"
