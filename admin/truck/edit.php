  ...
  <div class="span9" id="content">
      ...
      <div class="navbar">
        <div class="navbar-inner">
          <ul class="breadcrumb">
            ...
            <i class="fa fa-angle-right show-sidebar" style="display:none;"><a href="#" title="Show Sidebar" rel="tooltip">&nbsp;</a></i><li><a href="<?php echo $image_url ?>/dashboard.php">Dashboard</a> <span class="divider">/</span></li><li><a href="#">Truck </a> <span class="divider">/</span></li><li class="active">Edit Truck </li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="block">
      <div class="navbar navbar-inner block-header">
        <div class="muted pull-left">Edit Truck </div>
      </div>
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span6">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="truck_type" class="input-large" placeholder="Truck Type" id="truck_type" required="required" value="<?php echo $rown['truck_type']?>">
