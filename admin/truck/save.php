...
echo $sql="insert into tbl_truck(truck_partner_id,model,plate_no,truck_type,types,image,or_cr,status,created)values('$truck_partner_id','$model','$plate_no','$truck_type','truck','$image','$or_cr','$status','$created')"; 
