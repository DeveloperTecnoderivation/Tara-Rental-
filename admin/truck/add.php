  ...
  <div class="span9" id="content">
      ...
      <div class="navbar">
        <div class="navbar-inner">
          <ul class="breadcrumb">
            ...
            <i class="fa fa-angle-right show-sidebar" style="display:none;"><a href="#" title="Show Sidebar" rel="tooltip">&nbsp;</a></i><li><a href="<?php echo $base_url ?>/dashboard.php">Dashboard</a> <span class="divider">/</span></li><li><a href="#">Truck</a> <span class="divider">/</span></li><li class="active">Add Truck</li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="block">
      <div class="navbar navbar-inner block-header">
        <div class="muted pull-left">Add New Truck</div>
      </div>
            ...
            <div class="span12">
                <form action="save.php" method="post" id="add_form" name="add_form" class="form-horizontal" enctype="multipart/form-data" accept-charset="utf-8">
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span6">
                            <div class="control-group">
                                <label class="control-label" for="lastname">Truck Type</label>
                                <div class="controls">
                                    <input type="text" name="truck_type" class="input-large" placeholder="Truck Type" id="truck_type" required="required">
                                    <div id="truck_type_error" class="error_msg"></div>
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span6">
                            <div class="control-group">
                                <label class="control-label" for="photo">Truck Image</label>
                                <div class="controls">
...
<script language="javascript" type="text/javascript">
    function submitDetailsForm() {
      ...
      if((truck_type == '') || (truck_type == undefined)){
        $("#truck_type_error").text("This field are required");
        error = 0;
      }else{
        $("#truck_type_error").text("");
      }
