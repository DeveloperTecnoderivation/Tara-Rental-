...
echo $sql="insert into tbl_truck_partner(company_name,email,contact_person,contact_person_phone_mobile_code,contact_person_phone,password,company_type,business_permit_doc,business_permit_doc_status,bir_doc,bir_doc_status,cor_doc,cor_doc_status,ppa_doc,ppa_doc_status,ctap_doc,ctap_doc_status,acto_doc,acto_doc_status,mayors_permit_doc,mayors_permit_doc_status,sec_certificate_doc,sec_certificate_doc_status,articles_of_incorporation_doc,articles_of_incorporation_doc_status,inland_marine_insurance_doc,inland_marine_insurance_doc_status,oc_cr_doc,oc_cr_doc_status,pa_cpc_doc,pa_cpc_doc_status,deed_of_sale_doc,deed_of_sale_doc_status,bank_certificate1_doc,bank_certificate1_doc_status,bank_certificate2_doc,bank_certificate2_doc_status,fs_past_2yrs_doc,fs_past_2yrs_doc_status,gps_device_doc,gps_device_doc_status,organizational_chart_doc,organizational_chart_doc_status,status,created,created_by,ltfrb_doc,ltfrb_doc_status,refrence_number)values('$company_name','$email','$contact_person','$contact_person_phone_mobile_code','$contact_person_phone','$password','$company_type','$business_permit_doc','0','$bir_doc','0','$cor_doc','0','$ppa_doc','0','$ctap_doc','0','$acto_doc','0','$mayors_permit_doc','0','$sec_certificate_doc','0','$articles_of_incorporation_doc','0','$inland_marine_insurance_doc','0','$oc_cr_doc','0','$pa_cpc_doc','0','$deed_of_sale_doc','0','$bank_certificate1_doc','0','$bank_certificate2_doc','0','$fs_past_2yrs_doc','0','$gps_device_doc','0','$organizational_chart_doc','0','$status','$created','$created_by','$ltfrb_doc','0','$refrence_number')"; 
