...
?>
    ...
    <div class="span9" id="content">
          ...
          <div class="navbar">
            <div class="navbar-inner">
              <ul class="breadcrumb">
                ...
                <i class="fa fa-angle-right show-sidebar" style="display:none;"><a href="#" title="Show Sidebar" rel="tooltip">&nbsp;</a></i><li><a href="<?php echo $base_url ?>/dashboard.php">Dashboard</a> <span class="divider">/</span></li><li class="active">Truck View List</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="row-fluid">
          ...
          <div class="block">
            <div class="navbar navbar-inner block-header">
              <div class="muted pull-left">Truck Details list </div>
            </div>
            ...
            <div class="block-content collapse in">
              <div class="span12">
                ...
                <?php 
                    ...
                    $query_truck = "SELECT * FROM tbl_truck WHERE truck_partner_id = '$partner_id' AND types = 'truck'";
        ...
        <?php while($row = mysqli_fetch_assoc($result_truck)) { ?>
            ...
            $driver_sql = "SELECT f_name, l_name FROM tbl_users WHERE truck_id = '$truck_id' LIMIT 1";
