  ...
  <div class="span9" id="content">
      ...
      <div class="navbar">
        <div class="navbar-inner">
          <ul class="breadcrumb">
            ...
            <i class="fa fa-angle-right show-sidebar" style="display:none;"><a href="#" title="Show Sidebar" rel="tooltip">&nbsp;</a></i><li><a href="<?php echo $base_url ?>/dashboard.php">Dashboard</a> <span class="divider">/</span></li><li><a href="#">Pickup Port</a> <span class="divider">/</span></li><li class="active">Add Pickup Port</li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="block">
      <div class="navbar navbar-inner block-header">
        <div class="muted pull-left">Add New Pickup Port</div>
      </div>
                ...
                <form action="save.php" method="post" id="add_form" name="add_form" class="form-horizontal" enctype="multipart/form-data" accept-charset="utf-8">
                    <div class="row-fluid">
                        <div class="span6">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="port" class="input-large" placeholder="Pick Up Port" id="port" required="required">
                        ...
                        <div class="span6">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="code" class="input-large" placeholder="Code No." id="code" required="required">
                    ...
                    <div class="row-fluid">
                        <div class="span6">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="lat" class="input-large" placeholder="Latitutde" id="lat" required="required">
                        ...
                        <div class="span6">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="lng" class="input-large" placeholder="Longitude" id="lng" required="required">
                    ...
                    <div class="span12">
                        <div class="form-actions submit-form-left-pad">
                            <input type="button" name="add_driver" id="add_driver" value="Add" class="btn btn-primary" id="submit_button" onclick="submitDetailsForm()">
