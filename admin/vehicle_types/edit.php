  ...
  <div class="span9" id="content">
      ...
      <div class="navbar">
        <div class="navbar-inner">
          <ul class="breadcrumb">
            ...
            <i class="fa fa-angle-right show-sidebar" style="display:none;"><a href="#" title="Show Sidebar" rel="tooltip">&nbsp;</a></i><li><a href="<?php echo $base_url ?>/dashboard.php">Dashboard</a> <span class="divider">/</span></li><li><a href="#">Vechile Type</a> <span class="divider">/</span></li><li class="active">Edit Vechile Type</li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="block">
      <div class="navbar navbar-inner block-header">
        <div class="muted pull-left">Edit Vechile Type</div>
      </div>
      <div class="block-content collapse in">
        <div class="span12">
           <?php
            ...
            <?php
                $pid=$_REQUEST['pid'];
                $getdata="select * from tbl_vehicle_types where id=$pid";  
            ...
            <fieldset>              
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="name" class="input-xlarge focused" placeholder=" Name" id="name" required="required" value="<?php echo $rown['name']?>">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="seating_capacity" class="input-xlarge focused" placeholder="Seating Capacity" id="seating_capacity" required="required" value="<?php echo $rown['seating_capacity']?>">
    ...
    function submitDetailsForm() {
      ...
      if((seating_capacity == '') || (seating_capacity == undefined)){
        ...
        if(error == 1){
            ...
            $.ajax({
                url: '<?php echo $base_url ?>/vehicle_types/check_edit_exist.php',
                type: 'post',
                data: {
                  name: name,
                ...
                if (response == 'success') {
                    ...
                    toastr.error('Vehicle Types Already Exist!');
                 }else{
                    toastr.optionsOverride = 'positionclass = "toast-bottom-left"';
                    toastr.options.positionClass = 'toast-bottom-left';
