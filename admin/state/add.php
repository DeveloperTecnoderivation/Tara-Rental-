            ...
            <fieldset>
              ...
              <div class="control-group">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="state_code"  class="input-xlarge focused" placeholder="State Code" id="state_code" readonly="1">
                    </div>
                </div>
                
                <div class="form-actions">
                    <input type="submit" name="add_country" value="Add State" class="btn btn-primary" id="submit_button" disabled="true">
