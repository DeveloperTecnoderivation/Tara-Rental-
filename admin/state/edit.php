  ...
  <div class="span9" id="content">
      ...
      <div class="navbar">
        <div class="navbar-inner">
          <ul class="breadcrumb">
            ...
            <i class="fa fa-angle-right show-sidebar" style="display:none;"><a href="#" title="Show Sidebar" rel="tooltip">&nbsp;</a></i><li><a href="<?php echo $base_url ?>/dashboard.php">Dashboard</a> <span class="divider">/</span></li><li><a href="#">State</a> <span class="divider">/</span></li><li class="active">Edit State</li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="block">
      <div class="navbar navbar-inner block-header">
        <div class="muted pull-left">Edit State</div>
      </div>
    ...
    <div class="span12">
      ...
      <?php
          $pid=$_REQUEST['pid'];
          $getdata="select * from tbl_state where id=$pid";  
      ...
      ?>    
        <form action="update.php" method="post" id="add_state_form" name="add_state_form" class="form-horizontal" accept-charset="utf-8">
            <fieldset>
              ...
              <div class="control-group">
                    ...
                    <div class="controls">
                        <select  name="country_id" class="form-control" id="country_id" required="required" onchange="disableaddress()">
                          ...
                          ?>
                          <option value="<?php echo $country_list["id"];?>,<?php echo $country_list["country_code"];?>" <?php if($rown['country_id'] == $country_list["id"]){ echo "selected"; }?>><?php echo $country_list["country_name"];?></option> 
                          <?php } ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="state_name" class="input-xlarge focused" placeholder="State Name" id="state_name" readonly="1" value="<?php echo $rown['name']?>">
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="focusedInput">State Code</label>
                    <div class="controls">
                        <input type="text" name="state_code"  class="input-xlarge focused" placeholder="Country Code" id="state_code" readonly="1" value="<?php echo $rown['state_code']?>">
                    </div>
                </div>
                
                <div class="form-actions">
                  <input type="hidden" id="pid" name="pid" value='<?php echo $pid; ?>' >
                    <input type="submit" name="add_country" value="Update State" class="btn btn-primary" id="submit_button">
