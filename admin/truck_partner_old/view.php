          ...
          <div class="navbar">
            <div class="navbar-inner">
              <ul class="breadcrumb">
                ...
                <i class="fa fa-angle-right show-sidebar" style="display:none;"><a href="#" title="Show Sidebar" rel="tooltip">&nbsp;</a></i><li><a href="<?php echo $base_url ?>/dashboard.php">Dashboard</a> <span class="divider">/</span></li><li class="active">Truck Partner List</li>
              </ul>
            </div>
          </div>
        </div>
              ...
              <div class="span12">
                ...
                // echo $_GET['name'];
                    ...
                    if($_GET['status'] == '1'){
                     ...
                     $sql = "select * from  tbl_users  WHERE 1 = 1 and role='truck_partner' {$whereSQL1} {$whereSQL2} {$whereSQL3} {$whereSQL4} order by id asc";
