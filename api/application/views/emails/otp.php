                            ...
                            <tr>
                                ...
                                <tr>
                                    <td style="font-size:12px; color:#000; line-height:18px;">
                                        <p style="margin:10px 0 0;"><strong style="width:150px;">Your Login OTP  :  <?php echo $otp; ?>
                                    </td>
                                </tr>
				                ...
				                <tr>
				                    <td style="font-size:12px;color:#000; line-height:18px;">
				                        <p style="margin:10px 0 0;">If you need any assistance, please submit an inquiry on the contact tab or email us at <a href="mailto:info@avriant.com" style="color:#000; text-decoration: underline;">info@avriant.com</a>.</p>
